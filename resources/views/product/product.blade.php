        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 order-lg-1 order-2">
                    <ul class="image_list">
                        <li data-image="{{ url('images/single_4.jpg') }}">
                            <img src="{{ url('images/single_4.jpg') }}" alt="">
                        </li>
                        <li data-image="{{ url('images/single_2.jpg') }}">
                            <img src="{{ url('images/single_2.jpg') }}" alt="">
                        </li>
                        <li data-image="{{ url('images/single_3.jpg') }}">
                            <img src="{{ url('images/single_3.jpg') }}" alt="">
                        </li>
                    </ul>
                </div>
